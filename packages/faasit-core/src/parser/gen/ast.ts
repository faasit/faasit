...
export type NamedElement = BlockBlock | CustomBlock | Expr | ScalarBlock | SemaPackage | ShapeBlock | StructBlock;
...
export interface BlockBlock extends AstNode {
    readonly $container: Instance | SemaPackage;
...
export interface BlockExpr extends AstNode {
    readonly $container: ListExpr | Property | SemaPackage | TypeCallExpr;
...
export interface CustomBlock extends AstNode {
    ...
    for_target?: Reference<NamedElement>
    name?: string
    props: Array<Property>
}
...
export interface ImportClause extends AstNode {
...
export const ImportClause = 'ImportClause';

export function isImportClause(item: unknown): item is ImportClause {
    return reflection.isInstance(item, ImportClause);
}
...
export interface Property extends AstNode {
    readonly $container: BlockBlock | BlockExpr | CustomBlock | LibBlock | ScalarBlock | ShapeBlock | StructBlock | UseBlock;
...
export interface QualifiedName extends AstNode {
    readonly $container: CustomBlock | ListExpr | Property | QualifiedName | SemaPackage | TypeCallExpr;
...
export interface SemaPackage extends AstNode {
    readonly $container: SemaPackage;
...
export class FaasitAstReflection extends AbstractAstReflection {
    ...
    getAllTypes(): string[] {
        return ['Block', 'BlockBlock', 'BlockExpr', 'CustomBlock', 'Expr', 'Import', 'ImportClause', 'Instance', 'LibBlock', 'ListExpr', 'Literal', 'LiteralBool', 'LiteralFloat', 'LiteralInt', 'LiteralString', 'NamedElement', 'Property', 'QualifiedName', 'ScalarBlock', 'SemaAtomicType', 'SemaPackage', 'ShapeBlock', 'StructBlock', 'TypeCallExpr', 'UseBlock'];
    }
