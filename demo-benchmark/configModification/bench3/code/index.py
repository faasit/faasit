...
class Sample:
    ...
    def update(n: int):
        ...
        try:
            ...
            client.update_function_with_options('faasit', 'message_receive', update_function_request, update_function_headers, runtime)
    ...
    def get_function():
        ...
        try:
            # 复制代码运行请自行打印 API 的返回值
            config = client.get_function_with_options('faasit', 'message_receive', get_function_request, get_function_headers, runtime)
...
def f(frt: FaasitRuntime):
    ...
    while True:
        try:
            v = frt.call("message_receive", {"x": 1})
            break
