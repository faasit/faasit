...
class CreateTrigger:
    ...
    def create_api_info():
        ...
        create_trigger_headers = fc__open_20210406_models.CreateAliasHeaders()
    ...
    def main():
        ...
        try:
            resp = client.create_trigger_with_options(
                'testService', "testFunction", create_trigger_request, create_trigger_headers, runtime)
            return resp
